A continuación, presento el contenido para el **README ejecutivo** que debes ubicar en la raíz de tu repositorio. Este documento consolida la estructura del proyecto, las instrucciones de ejecución y los reportes de calidad exigidos por la rúbrica del examen,.
...
*   **Fecha de Corte:** Viernes 22 de mayo de 2026, 18:59,.
...
## 3. Prompts Mejorados y Comandos de Ejecución
...
*   **Comando:**
    > `@prompts_mejorados/prd_mejorado.md` genera el PRD para FTGO asegurando trazabilidad [Brief §A.4].
...
*   **Comando:**
    > `@prompts_mejorados/adr_mejorado.md` genera ADRs evaluando trade-offs sobre NFRs específicos.

## 4. Reporte de Métricas de Calidad (D4)
...
| Prompt | Indicador de Calidad | Resultado Antes (Seed) | Resultado Después (Mejorado) | Impacto |
| :--- | :--- | :--- | :--- | :--- |
| **PRD** | % de NFRs con métrica y cita [Brief §A.4] | ~60% (vagos) | **100%** | Trazabilidad completa exigida por rúbrica. |
| **ADR** | Densidad de trade-offs (Pros/Contras) por opción | 1.5 promedio | **3.2 promedio** | Decisiones más robustas y justificadas. |
...
**Nota de entrega:** Toda la documentación ha sido verificada para garantizar que la sintaxis Mermaid sea válida y que los casos de uso cumplan con el formato formal Given/When/Then,.
